public struct FCMAndroidNotification: Sendable, Codable, Equatable {
    ...
    /// letiable string values to be used in place of the format specifiers
    ...
    public let bodyLocalizationArgs: [String]?
    ...
    /// See Formatting and Styling for more information.
    public let titleLocalizationArgs: [String]?
    ...
    public let visibility: FCMAndroidNotificationVisibility?
    ...
    public let lightSettings: FCMAndroidNotificationLightSettings?
